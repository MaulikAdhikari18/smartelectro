    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-16"
      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg" style={{ color: '#64748b' }}>Join 25,000+ B2B buyers and suppliers</p>
        </div>
        ...
        <div className="rounded-2xl p-10" style={{ background: '#1e293b', border: '1px solid #334155' }}>
          ...
          {error && (
            <div className="mb-6 px-5 py-4 rounded-lg text-base font-medium"
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <label className="block text-base font-medium mb-2.5" style={{ color: '#94a3b8' }}>Full Name *</label>
                <input type="text" required value={form.name}
                  onChange={e => setForm({ ...form, name: e.target.value })}
                  placeholder="Rajesh Kumar"
                  className="w-full px-5 py-4 rounded-xl text-base outline-none text-white"
                  style={{ background: '#0f172a', border: '1px solid #334155' }}
                  onFocus={e => (e.target.style.borderColor = '#f59e0b')}
                  onBlur={e => (e.target.style.borderColor = '#334155')} />
              </div>
              <div>
                <label className="block text-base font-medium mb-2.5" style={{ color: '#94a3b8' }}>Phone Number</label>
            ...
            <div>
              <label className="block text-base font-medium mb-2.5" style={{ color: '#94a3b8' }}>
              ...
              <input type="text" value={form.gstNumber}
                ...
                onFocus={e => (e.target.style.borderColor = '#f59e0b')}
                onBlur={e => (e.target.style.borderColor = '#334155')} />
              <p className="text-sm mt-1.5" style={{ color: '#475569' }}>Required for GST invoicing and verification</p>
            </div>
