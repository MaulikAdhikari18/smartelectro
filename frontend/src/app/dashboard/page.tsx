                            ...
                            <div className="card p-6">
                                ...
                                <div className="space-y-3">
                                    {(isSupplier ? [
                                        ...
                                        { label: '🏪 View My Store', href: '/suppliers/me', onClick: undefined as (() => void) | undefined },
                                    ] : [
                                        { label: '🔍 Browse Products', href: '/products', onClick: undefined as (() => void) | undefined },
                                        { label: '📩 Post a Requirement', href: '/rfq', onClick: undefined as (() => void) | undefined },
                                        { label: '📦 Track Orders', href: '#', onClick: () => setTab('orders') },
                                    ]).map((action: { label: string; href: string; onClick: (() => void) | undefined }) => (
                                        action.onClick
